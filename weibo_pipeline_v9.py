...
# -*- coding: utf-8 -*-
"""
weibo_pipeline_v12.py

Changes from v11: ALPHA 30 -> 50, RECENCY_WINDOW 45 -> 35.

Sweep 7 ablation val scores (Jul-2015, 3k users):
  v11 baseline (A=30, rw=45): 0.3708
  ALPHA=50 + rw=35d:          +0.0096
"""
import os
import re
import time
...
RESULT_PATH    = 'Weibo Data/weibo_result_data/weibo_result_data_v12.txt'
