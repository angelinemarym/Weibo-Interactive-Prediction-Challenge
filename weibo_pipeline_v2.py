...
# -*- coding: utf-8 -*-
"""
weibo_pipeline_v2.py

Key improvement over v1: hybrid engagement × recency weighting.

Problem with v1 (hl=30, uniform engagement weight):
...
CV scores (pre-Jul→Jul / pre-Jun→Jun):
  v1 (hl=30)               : 0.3031 / 0.2975  avg=0.3003
  v2 (hl=90, rot=30, α=0)  : 0.3093 / 0.2969  avg=0.3031  ← best
"""
import os
import time
import numpy as np
...
RESULT_PATH      = 'Weibo Data/weibo_result_data/weibo_result_data_v2.txt'
