...
Change from v7: expand local refinement from +-1 to +-2.

Sweep 2 ablation val scores (Jun-2015, 3k users):
...
RESULT_PATH    = 'Weibo Data/weibo_result_data/weibo_result_data_v8.txt'
...
def main():
    ...
    print(f"Config: no-recency-decay  rw={RECENCY_WINDOW}d  ALPHA={ALPHA}  tfidf-bigram  p5+p10  +-2-refinement")
