...
# -*- coding: utf-8 -*-
"""
weibo_pipeline_v6.py

Improvement over v5: ALPHA 5→8, add p5 candidate.

v5 (ALPHA=5, p10 added) scored 0.3144 vs v10 (ALPHA=3, no p10) 0.3139.
Trend: stronger content signal helps. Pushing further.

Changes from v5:
  ALPHA: 5.0 → 8.0
  Candidates: add p5 → {0, p5, p10, p25, p50, p75, p90, weighted_mean}
              (still capped at MAX_CANDS=8, all 8 slots now used)

Everything else identical to v5/v3.
"""
import os
import time
import math
...
RECENCY_WINDOW = 30.0
MAX_CANDS      = 8
ALPHA          = 8.0   # content similarity multiplier
...
def main():
    ...
    print(f"Config: hl={HALF_LIFE}d  rw={RECENCY_WINDOW}d  ALPHA={ALPHA}  tfidf-bigram  p5+p10")
